package com.bolsadeideas.springboot.reactor.app.handler;
...
import com.bolsadeideas.springboot.reactor.app.models.dao.CategoriaDao;
...
public class ProductoHandler {
	...
	ProductoHandler(CategoriaDao categoriaDao) {
	...
	public Mono<ServerResponse> ver(ServerRequest request) {
		String id = request.pathVariable("id");
		return service.findById(id).flatMap(p -> ServerResponse.ok().contentType(MediaType.APPLICATION_JSON_UTF8)
